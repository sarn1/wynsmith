            ...
            <div class="row">
                <div class="medium-6 columns">
                    ...
                    if ($page_id == 28) {
                        //company video page
                    ?>
                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/nVta7w7y1NI" frameborder="0" allowfullscreen></iframe>
                    <?php
                    }
                    elseif($page_id == 18) {
                        //mortgage page
...
<table cellpadding="0" cellspacing="0" width="100%" align="center"><tr><td id="params" valign="top">
...
<tr><td align="right">Loan Term (In Years):</td><td><input type="text" name="param[term]" value="30" size="4"></td></tr>
